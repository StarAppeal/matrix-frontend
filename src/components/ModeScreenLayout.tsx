    ...
    return (
        <ThemedBackground>
            <View className="flex-1 w-full items-center">
                ...
                <View className="w-full max-w-xl px-4 pt-4">
                    <ThemedHeader subtitle={subtitle}>
                        {title}
                    </ThemedHeader>
                </View>
                ...
                >
                    <View className="w-full max-w-xl px-4">
                        ...
                        {children && (
                            <View
                                className="bg-surface dark:bg-surface-dark rounded-2xl p-6 mt-4 shadow-sm border border-outline/10 gap-6">
                                <View className="items-center mb-2">
                                    ...
                                    <Text
                                        className="text-base font-medium text-onSurface dark:text-onSurface-dark text-center">
                                        {settingsTitle}
                                    </Text>
                                    {settingsDescription && (
